    ...
    return (
        ...
        >
            ...
            <div className="border-b bg-gray-100">
                ...
                <div className="text-3xl text-center font-medium p-4">
                    Checkout
                </div>
            </div>
                                ...
                                return (
                                    ...
                                    >
                                        <input
                                            ...
                                            onChange={(e) =>
                                                shippingAddressChangeHandler(e)
                                            }
                                        />
                                        <label
                                            htmlFor="selectAddress"
                                            className="px-4"
                                        >
                                        ...
                                        <span
                                            ...
                                            onClick={() =>
                                                showEditAddressHandler(item)
                                            }
                                        >
                                            Edit Address
                                        </span>
                                        <span className="text-sm text-blue-800 mx-2">
                                            |
                                        </span>
                                        <span
                                            className="text-sm text-blue-800 hover:cursor-pointer hover:underline hover:text-red-800"
                                            onClick={() =>
                                                addressDeleteHandler(item._id)
                                            }
                                        >
                                            Delete Address
                                        </span>
